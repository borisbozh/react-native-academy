import { addNewPost, getAllPosts, deletePost, editPost } from './blogs-api-client.js';
import { chipsInstances } from './materialize_helpers.js';
...
// addPostForm.addEventListener(`edit`, editPost)
...
export function addPost(post) {
  ...
  postElem.innerHTML = `
    ...
    <div class="card-action">
      ...
      <button class="btn waves-effect waves-light red lighten-1" type="button" id="delete" onsubmit="deletePost(${post.id})">Delete
